...
| **9/9/24**   | Lesson 4: Introduction to R and RStudio                                                 | Quiz #4<br>Exercise #4   | [slides](/lecture_slides/04_lesson_m3dm/04_lesson_m3dm.html){target="_blank"} | - [**Video**: RStudio is now Posit!](https://www.youtube.com/watch?v=0_UNtwEh7kY){target="_blank"}                            |
